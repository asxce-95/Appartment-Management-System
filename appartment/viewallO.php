      ...
      <div class="container">
        ...
        <div class="row block-9 justify-content-center mb-5">
          <div class="col-md-12 mb-md-5">
          	<h2 class="text-center"><br>All Flat Owner</h2>
				<div class="container">
				  ...
				  <table class="table table-bordered table-striped">
					...
					<tbody id="myTable">
						<?php	
//---------------PHP------------------		
						$sql1="SELECT * FROM ownerdetails WHERE ownerID<>'No Owner' AND status='Active' AND type<>'tenant'";
							  $result1=$connect->query($sql1);
...
//---------------PHP------------------		
							?>
					  <tr>
						<td><a href="profile.php?oid=<?php echo $row1['ownerID'] ?>"><?php echo $row1['ownerID'] ?></a></td>
						<td><?php echo $row1['fname'] ?> <?php echo $row1['lname'] ?></td>
						<td><?php echo $row1['mobile'] ?></td>
						<td><?php echo $row1['email'] ?></td>
						<td><?php if($row['type']=="secretary" && $row1['status']=="Active") { ?>
							<form method="post" action="oedit.php"><input type="hidden" name="oid" value="<?php echo $row1['ownerID'] ?>"><input type="submit" name="viewP" value="View/Update"> </form>
							</td><td><form method="post" action="viewallO.php"><input type="hidden" name="oid" value="<?php echo $row1['ownerID'] ?>"><input type="submit" name="Odelete" value="Delete"> </form>																
...
$sql="UPDATE `ownerdetails` SET status='Deleted' WHERE `ownerID`='$oid'";
