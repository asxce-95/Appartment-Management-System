...
$pdf->Cell(25 ,5,'OwnerID ',1,0);
$pdf->Cell(20 ,5,'Amount',1,0);
$pdf->Cell(50 ,5,'Description',1,0);
$pdf->Cell(20 ,5,'Status',1,1);

$sql1="SELECT * FROM `dues` WHERE ID='".$_GET['tid']."'";
$result1=$connect->query($sql1);
while($row=$result1->fetch_assoc()){

  $pdf->Cell(20 ,5,$row['ID'],1,0);
  $pdf->Cell(55,5,$row['adate'],1,0);
  $pdf->Cell(25 ,5,$row['ownerID'],1,0);
  $pdf->Cell(20 ,5,$row['amt'],1,0);
  $pdf->Cell(50 ,5,$row['dd'],1,0);
...
$pdf->Output($filename,'F');
	...
	require 'PHPMailer/PHPMailerAutoload.php';
				...
				$mail->Subject = 'Akruti: You have Due Update';
				$msgg="PFA, the required Due Recipt";
				$mail->msgHTML($msgg);
