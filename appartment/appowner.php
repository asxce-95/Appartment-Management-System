   			...
   			<div class="container">
				  ...
				  <table class="table table-bordered table-striped">
					...
					<tbody id="myTable">
						<?php	
//---------------PHP------------------		
						$sql1="SELECT * FROM ownerdetails WHERE ownerID<>'No Owner' AND status='Pending'";
							  $result1=$connect->query($sql1);
							  $num1= $result1->num_rows;
							  if($num1==0)
							  {
								?> <h5>No Owner to Approve<h5><?php 
							  }
							  else
							  {
...
//---------------PHP------------------		
					  ...
					  <tr>
						...
						<td><?php if($row['type']=="president") { ?>
							<form method="post" action="appowner.php"><input type="hidden" name="oid" value="<?php echo $row1['ownerID'] ?>"><input type="submit" name="appO" value="Approve"> </form>															
...
$sql="UPDATE `ownerdetails` SET status='Active' WHERE `ownerID`='$oid'";
