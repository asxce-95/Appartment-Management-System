...
$tidd=$_GET['tidd'];
	$sql1="SELECT * FROM ownerDetails WHERE ownerID='$tidd'";
      ...
      <div class="container">
        ...
        <div class="row block-9 justify-content-center mb-5">
          <div class="col-md-8 mb-md-5">
            ...
            <form action="edittenant.php" method="post" enctype="multipart/form-data" class="bg-light p-5 contact-form">
              <div class="form-group">
                <input class="form-control" placeholder="Flat Number" pattern="[0-9]{2}" name="flatno" type="text" value="<?php echo $row2['flatno']; ?>" class="validate" readonly>
              </div>
			  <div class="form-group">
                <input class="form-control"  name="tidd" type="hidden" value="<?php echo $tidd; ?>" >
              </div>
              <div class="form-group">
                <input type="text" class="form-control" id="email" type="email" class="validate" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" name="email" value="<?php echo $row2['email']; ?>" readonly>
              </div>
			    <div class="form-group">
                <input type="text" class="form-control" id="mob" pattern="[987][0-9]{9}" name="mob" value="<?php echo $row2['mobile']; ?>" type="text" class="validate" placeholder="Mobile" required>
              </div>
              <div class="form-group">
                <input class="form-control" placeholder="First Name" pattern="[A-Za-Z]+" name="fname" value="<?php echo $row2['fname']; ?>" type="text" class="validate" required>
              </div>
              <div class="form-group">
			  ...
			  <div class="form-group">
                <input class="form-control" placeholder="Occupation" pattern="[A-Za-Z]+" name="occ" type="text" value="<?php echo $row2['occ']; ?>" class="validate" >
				  ...
				  <div class="form-group">
					<input class="form-control" id="2" placeholder="Vehile Registration/ Enter '-' if not present" pattern="[A-Za-Z]+" name="vr" value="<?php echo $row2['vr']; ?>" type="text" class="validate" required>
				  </div>
           ...
           <div class="form-group">
              ...
              <div class="form-group">
                <input type="submit" value="Update"  type="submit" id="button"  name="submit" class="btn btn-primary py-3 px-5">
              </div>
            </form>
...
if(isset($_FILES['perm']['name'])){		
				$name = $_FILES['perm']['name'];
					...
					$sql="UPDATE `ownerdetails` SET `fname`='".$_POST['fname']."',
						...
						`cadd` ='$cadd',`padd` ='$padd',vr='".$_POST['vr']."',mobile='$mob' WHERE `ownerID`='$tidd'";
