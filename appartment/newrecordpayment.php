...
var row = '<div class="form-group"  id="tit" ><input class="form-control" placeholder="Card Number" pattern="[0-9]{10}"  name="card" type="text" required> </div>			<div class="form-group"><input class="form-control" placeholder="Enter Pin" pattern="[0-9]{4}"  name="pin" type="text" required> </div> ';
 ...
 function copy1()
     {
         ...
         $("#tit").remove();
		 var row = '<div class="form-group"  id="tit2"><input class="form-control" placeholder="UPI Address" pattern="[A-Za-Z0-9]+[@][A-Za-Z]+"  name="upi" type="text" required> </div>';
...
$period=$_POST['period'];
	...
	?>
	  ...
	  <form action="newrecord.php" method="post" enctype="multipart/form-data" class="bg-light p-5 contact-form" id="treasurer">
...
<!--option value="UPI" onClick="copy1();">UPI</option-->
<option value="Card" id="che" onClick="copy();">Card</option>
...
<option value="OSD">One time society deposit</option--->
		  ...
		  <div class="form-group"  id="tit" >
			<input class="form-control" placeholder="Card Number" pattern="[0-9]{10}"  name="card" type="text" required> 
		</div>
		<div class="form-group">
			<input class="form-control" placeholder="Enter Pin" pattern="[0-9]{4}"  name="pin" type="text" required>
		</div>

             <!--div class="input-group mb-3" id="t">
<div class="input-group-prepend">
<label class="input-group-text" for="inputGroupSelect01">Payment Mode</label>
</div>
<select class="custom-select"  name="mop" id="inputGroupSelect01">
<option value="Cash" onClick="copy1();">UPI</option>
<option value="Card" id="che" onClick="copy();">Card</option>
