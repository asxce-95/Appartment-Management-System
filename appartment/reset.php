   ...
   // $confirm  = md5($_POST['confirm']);
    ...
    if($updatePass){
        $query = mysqli_query($connect,"DELETE FROM reset where code = '$code' ");
								$m='Password Updated, Please Login with the New Password';
      ...
      <div class="container">
        ...
        <div class="row block-9 justify-content-center mb-5">
          <div class="col-md-8 mb-md-5">
          	<h2 class="text-center">Please Set your password</h2>
            <form action="reset.php" method='post' class="bg-light p-5 contact-form">
          ...
          <input type="hidden"name='code' value="<?php echo $code;?>">   
              <div class="form-group">
                <input  type="submit" id="button"  name="reset" value="Set Password" class="btn btn-primary py-3 px-5">
              </div>
            </form>
