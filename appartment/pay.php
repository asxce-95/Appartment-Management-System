      ...
      <div class="container">
        ...
        <div class="row block-9 justify-content-center mb-5">
          <div class="col-md-8 mb-md-5">
             ...
             <form action="recordpayment.php" method="post" enctype="multipart/form-data" class="bg-light p-5 contact-form" id="treasurer">
...
//---------------PHP------------------		
?>
<option value="<?php echo $row2['ownerID'] ?>"><?php echo $row2['fname']." ".$row2['lname'] ?></option>
