...
if(isset($_POST['submit']))
{
 ...
 // $oid = $_POST['oid'];
  ...
  $sql="INSERT INTO notice (subject,datetoday,address,referenceno,letter) VALUES (?,?,?,?,?)";

if($stmt = mysqli_prepare($connect, $sql)){
         // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssss",$param_sub, $param_date,$param_address, $param_referenceno,$param_letter);
      ...
      <div class="container">
        ...
        <div class="row block-9 justify-content-center mb-5">
          <div class="col-md-8 mb-md-5">
            <h2 class="text-center">Enter Notice Details</h2>
            <form action="#" method="post" class="bg-light p-5 contact-form" id="letterform">
              ...
              <div class="form-group">
                <input id="" class="form-control" placeholder="Address" name="address"  value="Akruti Heights" type="text" required>
              </div>

            <h2>Type Notice here</h2>
