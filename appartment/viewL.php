   			...
   			<div class="container">
				  ...
				  <table class="table table-bordered table-striped">
					...
					<tbody id="myTable">
						<?php	
//---------------PHP------------------		
						$sql1="SELECT * FROM letter WHERE ownerID='".$row['ownerID']."' and status='Approved'";
						//echo $sql1;
							  $result1=$connect->query($sql1);
...
//---------------PHP------------------		
					  ...
					  <tr>
						...
						<td><a href="pdf1.php?lid=<?php echo $row1['lid'] ?>"><?php echo $row1['subject'] ?></a></td>
...
$sql="UPDATE `letter` SET `status` = 'Aprroved' WHERE `letter`.`lid` = '$lid' ";
